...
export const defaultPortfolioContent: PortfolioContent = {
  site: {
    ...
    bio: "This portfolio is ready for your story. Use the owner dashboard to shape the narrative, introduce your experience, and turn each selected project into a considered case study.",
  ...
  projects: [
    {
      id: "placeholder-1",
      slug: "your-first-case-study",
      title: "Your first case study",
      category: "Full-stack",
      summary: "A deliberately empty canvas for a project that deserves a considered story.",
      description: "Replace this placeholder in the owner dashboard with a genuine project, its role, its technical decisions, and the visual evidence that makes the work memorable.",
      role: "Add your role",
      tech: ["Add", "your", "stack"],
      liveUrl: "",
      codeUrl: "",
